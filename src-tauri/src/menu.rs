...
pub(crate) fn menu() -> Menu {
  let about_menu = AboutMetadata::new()
    ...
    .comments(String::from("Teleport Transactions GUI"))
    .copyright(String::from("GPL-3.0 License"))
    .license(String::from("GPL-3.0 License"))
    .website(String::from("https://github.com/pwltr/coinportal"))
  ...
  Menu::new()
    .add_submenu(Submenu::new(
      "CoinPortal",
      Menu::new()
        .add_native_item(MenuItem::About("CoinPortal".to_string(), about_menu))
